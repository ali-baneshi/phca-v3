...
| G3-INV-02 | G3 | EVAL | P0 | Φ-IQ L2 planner-dominated under default | **Documented** (not fixed — metric design) |
...
| G2-INV-05 | G2 | EVAL | P0 | Causal mixed L2/L3 | **Open** (behavioral; out of scope) |
...
| G4-INV-12 | G4 | EVAL | P1 | Aggregate vs mean per-seed FR | **Documented** |
...
| G3-INV-20 | G3 | EVAL | P1 | A4 assumption = MPC structural | **Documented** |
