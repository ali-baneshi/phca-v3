...
> **⚠️ STALE (۲۰۲۶-۰۷-۰۵):** وضعیت فازهای ۱۳–۲۰ در این سند قدیمی است.
> منبع زنده: [PHCA_Cognitive_Observatory_Architecture.md](PHCA_Cognitive_Observatory_Architecture.md)
> و [STATUS.md](../STATUS.md) — فازهای ۷–۲۰ تکمیل شده‌اند.
